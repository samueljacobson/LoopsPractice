...
namespace LoopsPractice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Ask user for a word or phrase, print number of each vowel to the console
            ...
            Console.WriteLine("Your phrase has " + vowelA + " A's.");
            Console.WriteLine("Your phrase has " + vowelE + " E's.");
            Console.WriteLine("Your phrase has " + vowelI + " I's.");
            Console.WriteLine("Your phrase has " + vowelO + " O's.");
            Console.WriteLine("Your phrase has " + vowelU + " U's.");
